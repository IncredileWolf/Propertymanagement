          ...
          <Row className="mt-3">
            <Col md="3" lg="4" xl="3" className="mx-auto mb-4">
              ...
              <p className="text-justify">
                1. "Discover your ideal home effortlessly with our user-friendly
                property website, simplifying the search for your perfect
                abode.".
              </p>
            </Col>
            ...
            <Col md="4" lg="3" xl="3" className="mx-auto mb-md-0 mb-4">
              ...
              <p>
                ...
                Mumbai league of education ,IIT Bandra Mumbai
              </p>
              <p>
              ...
              <p>
                <i className="fas fa-phone me-3"></i> + 91 8283245638
              </p>
              <p>
                <i className="fas fa-print me-3"></i> + 91 9936728823
              </p>
            </Col>
          </Row>
        </Container>
