  ...
  return (
    <div className="b">
      ...
      >
        ...
        >
          Property{" "}
          <span style={{ color: "rgb(13, 95, 166)" }}>Owner Registration</span>{" "}
          {""}
          Form
        </div>{" "}
        <form onSubmit={handleSubmit}>
          <div className="user-details">
            ...
            <div className="input-box">
              ...
              >
                ...
                {errors.contactno && touched.contactno ? (
                  <span className="errors">{errors.contactno}</span>
                ) : null}
              </span>
              <input
                type="number"
            ...
            <div className="input-box">
              ...
              >
                ...
                {errors.question && touched.question ? (
                  <span className="errors">{errors.question}</span>
                ) : null}
              </span>
              <select
                name="question"
            ...
            <div className="input-box">
              ...
              >
                ...
                {errors.answer && touched.answer ? (
                  <span className="errors">{errors.answer}</span>
                ) : null}
              </span>
              <input
                type="text"
            ...
            <div className="input-box">
              ...
              >
                Adhar Card Photo
                {errors.uidPic && touched.uidPic ? (
                  <span className="errors">{errors.uidPic}</span>
                ) : null}
              </span>
              <input
                type="file"
