        ...
        <div className="user-details">
          ...
          <div className="input-box">
            ...
            <input
              ...
              min={1}
              disabled
              placeholder="Enter no of House Available"
          ...
          <div className="input-box">
            <span className="details">Property Photo 1</span>
            <input
              type="file"
          ...
          <div className="input-box">
            <span className="details">Property Photo 2</span>
            <input
              type="file"
              placeholder="First Photo"
          ...
          <div className="input-box">
            <span className="details">Property Photo 3</span>
            <input
              type="file"
              placeholder="First Photo"
          ...
          <div className="input-box">
            <span className="details">Property Photo 4</span>
            <input
              type="file"
              placeholder="First Photo"
